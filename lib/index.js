...
export async function apply(ctx, config) {
  ...
  // ── 从上游 dsh-remote 0.8.7 合并的工具 ─────────────────────────────────
    defineTool({
      ...
      output: { schema: { type: 'object', properties: { text: { type: 'string' } } }, render: (_a, a) => [{ type: 'text', text: a.text }] },
      async execute(args) {
    ...
    defineTool({
      ...
      output: { schema: { type: 'object', properties: { ok: { type: 'boolean' }, text: { type: 'string' } } }, render: (_a, a) => [{ type: 'text', text: a.text }] },
      async execute(args) {
